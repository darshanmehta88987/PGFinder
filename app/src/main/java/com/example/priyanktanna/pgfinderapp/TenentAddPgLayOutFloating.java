...
public class TenentAddPgLayOutFloating extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_next:
                ...
                Intent intent = new Intent(TenentAddPgLayOutFloating.this, FloatingTenentAddPgLayOut.class);
