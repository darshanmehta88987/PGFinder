...
class MyWishlistAdapter extends BaseAdapter {

    Context context;
    ArrayList<Tenent1Model> list;

    public MyWishlistAdapter(Context context, ArrayList<Tenent1Model> wishlistModelArrayList) {
        this.context=context;
        this.list=wishlistModelArrayList;
    }
