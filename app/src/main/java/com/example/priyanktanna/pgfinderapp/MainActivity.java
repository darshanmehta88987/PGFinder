...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("PGFINDER", Context.MODE_PRIVATE);
         strFn = sharedPreferences.getString("USER_FN","");
       //  Log.e("sssssss___","___"+strFn);
         strln = sharedPreferences.getString("USER_LN","");
        CircleImageView circleImageView = (CircleImageView)hView.findViewById(R.id.imageView);
        TextView nav_user = (TextView)hView.findViewById(R.id.tv_data);
