...
class MyTenentAdapter extends BaseAdapter {

    Context context;
    ArrayList<Tenent1Model> list;

    public MyTenentAdapter(Context context, ArrayList<Tenent1Model> tenent1ModelArrayList) {

        this.context=context;
        this.list=tenent1ModelArrayList;
  ...
  //      }
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, TenentPgDisplayInActivity.class);
