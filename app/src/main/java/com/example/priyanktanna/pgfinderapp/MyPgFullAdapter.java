...
class MyPgFullAdapter extends PagerAdapter {
    ...
    public MyPgFullAdapter(Context context, ArrayList<String> url) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        View myImageLayout = inflater.inflate(R.layout.raw_page_full_pg, view, false);
