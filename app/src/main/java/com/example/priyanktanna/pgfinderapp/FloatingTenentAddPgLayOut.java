...
public class FloatingTenentAddPgLayOut extends AppCompatActivity implements View.OnClickListener {
...
*/
                ...
                editor.putString("Te_KEY", strTenentId);
                editor.commit();

                startActivity(new Intent(FloatingTenentAddPgLayOut.this, TabActivity.class));
                                    finish();
